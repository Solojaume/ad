...
public partial class MainWindow
{
	...
	protected virtual void Build()
	{
		...
		this.UIManager.AddUiFromString(@"<ui><toolbar name='toolbar1'><toolitem name='newAction' action='newAction'/><toolitem name='editAction' action='editAction'/><toolitem name='deleteAction' action='deleteAction'/><toolitem name='refreshAction' action='refreshAction'/><toolitem/><toolitem name='quitAction' action='quitAction'/></toolbar></ui>");
